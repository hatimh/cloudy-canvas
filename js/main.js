...
function init() {
    var canvas = document.getElementById('headerAnimation');
...
function draw() {
  ...
  grd.addColorStop(0,"rgba(23,137,222,1)");
  grd.addColorStop(1,"rgba(200,200,200,1)");

    context.fillStyle = grd;
    context.fillRect(0, 0,window.innerWidth, 600);
